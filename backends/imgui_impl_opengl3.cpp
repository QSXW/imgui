...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxInnerColor, 4, GL_UNSIGNED_BYTE, GL_TRUE,  sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, col)));
#ifndef IMGUI_DISABLE_SDF
    if (sdf) {
        GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxStartOuterColor, 4, GL_UNSIGNED_BYTE, GL_TRUE,  sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, startOuterColor)));
        GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxEndOuterColor,   4, GL_UNSIGNED_BYTE, GL_TRUE,  sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, endOuterColor)));
        GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxA,               1, GL_FLOAT,         GL_FALSE, sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, a)));
        GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxB,               1, GL_FLOAT,         GL_FALSE, sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, b)));
        GL_CALL(glVertexAttribPointer(bd->AttribLocationVtxW,               1, GL_FLOAT,         GL_FALSE, sizeof(ImDrawVert), (GLvoid*)offsetof(ImDrawVert, w)));
    }
#endif
}
...
#define LAYOUT(location, definition) "#if defined(__VERSION__) >= 300\nlayout (location = " location ") " definition ";\n#else\n" definition ";\n#endif\n"
    ...
    bd->AttribLocationVtxInnerColor = (GLuint)glGetAttribLocation(bd->ShaderHandle, "Color");
#ifndef IMGUI_DISABLE_SDF
    if (sdf) {
