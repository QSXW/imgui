...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        ID3DBlob* pError;
        if (FAILED(D3DCompile(vertexShader, strlen(vertexShader), nullptr, nullptr, nullptr, "main", "vs_4_0", 0, 0, &vertexShaderBlob, &pError))) {
            if (pError) {
...
#ifndef IMGUI_DISABLE_SDF
            { "COLOR",    1, DXGI_FORMAT_R8G8B8A8_UNORM, 0, (UINT)offsetof(ImDrawVert, startOuterColor),  D3D11_INPUT_PER_VERTEX_DATA, 0 },
            { "COLOR",    2, DXGI_FORMAT_R8G8B8A8_UNORM, 0, (UINT)offsetof(ImDrawVert, endOuterColor),  D3D11_INPUT_PER_VERTEX_DATA, 0 },
            { "COLOR",    3, DXGI_FORMAT_R32_FLOAT,      0, (UINT)offsetof(ImDrawVert, a), D3D11_INPUT_PER_VERTEX_DATA, 0 },
            { "COLOR",    4, DXGI_FORMAT_R32_FLOAT,      0, (UINT)offsetof(ImDrawVert, b), D3D11_INPUT_PER_VERTEX_DATA, 0 },
            { "COLOR",    5, DXGI_FORMAT_R32_FLOAT,      0, (UINT)offsetof(ImDrawVert, w), D3D11_INPUT_PER_VERTEX_DATA, 0 },
#endif
        };
#ifndef IMGUI_DISABLE_SDF
